...
public class DropStashHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		GitStashDialog dialog = new GitStashDialog(window.getShell(),gitStashData,GitStash.DROP);
		dialog.create();
		if (dialog.open() == Window.OK) {
		    System.out.println(dialog.getSelectedStashId());
		    String stashMsg = dialog.getStashMessage();
		    String message =  GitHandlerUtil.gitStashDrop(resource,dialog.getSelectedStashId());
		    message = message + "\n"+stashMsg;
